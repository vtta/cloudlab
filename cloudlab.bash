...
sudo apt -y install doca-all fish neovim tree-sitter-cli python3-pynvim ripgrep fd-find fzf zoxide eza tree jq libarchive-tools luarocks apt-file bmon net-tools rsync git tmux rustup golang python3-dev python3-venv python3-requests libibverbs-dev libssl-dev rlwrap nodejs cmake redis protobuf-compiler jupyter
